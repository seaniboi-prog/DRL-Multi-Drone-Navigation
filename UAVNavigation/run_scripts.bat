...
@REM python single_uav_experiment.py -a sac -i 5 -w random_single -v single --best

@REM echo Single UAV Experiment Multiple with SAC
@REM python single_uav_experiment.py -a sac -i 5 -w random_multiple -v multiple --best

@REM echo Single UAV Experiment Obstacle with SAC
@REM python single_uav_experiment.py -a sac -i 5 -w random_multiple -v obstacle --best
