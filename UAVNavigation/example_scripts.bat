...
python train_drone_algo_rllib.py -t disc -a ppo -i 30 -b 4096 -w random_single --tuned

echo Training Disc Random Multiple with PPO
python train_drone_algo_rllib.py -t disc -a ppo -i 40 -b 4096 -w random_multiple --tuned

echo Training Cont Random Single with PPO
python train_drone_algo_rllib.py -t cont -a ppo -i 30 -b 4096 -w random_single --tuned

echo Training Cont Random Multiple with PPO
python train_drone_algo_rllib.py -t cont -a ppo -i 40 -b 4096 -w random_multiple --tuned
