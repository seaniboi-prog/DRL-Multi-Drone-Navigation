...
from telegram_utils import wait_for_response, send_message
...
while i < total_iters:
    try:
        ...
        eval_rewards, eval_lengths, success_rate, crashes, timeouts, route_list, time_list = evaluate_algorithm(restored_algo, select_env, epochs=5, env_config=env_config, render_mode=render_mode)
