...
waypoints["far"] = [
                np.array([7.0, -27.0, 7.0], dtype=np.float32), # starting point
                np.array([60.0, -30.0, 6.0], dtype=np.float32),
                np.array([75.0, -10.0, 5], dtype=np.float32),
            ]

waypoints["multiple"] = [
                np.array([4.0, -10.0, 3.0], dtype=np.float32), # starting point
...
waypoints["cust"] = [
                np.array([14.0, -10.0, 3.0], dtype=np.float32), # starting point
